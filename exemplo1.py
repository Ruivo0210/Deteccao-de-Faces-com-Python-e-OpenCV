...
classificador = cv2.CascadeClassifier('cascades/haarcascade_frontalface_default.xml') #Aqui, atribuimos uma variável para o classificador XML. Este está treinado para reconhecer rostos.

imagem = cv2.imread('pessoas/beatles.jpg')
imagemcinza = cv2.cvtColor(imagem, cv2.COLOR_BGR2GRAY)

facesDetectadas = classificador.detectMultiScale(imagemcinza) #Este comando serve para fazermos a detecção na imagem baseado naquilo que o classificador é treinado.
