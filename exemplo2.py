...
for(x,y,l,a) in facesDetectadas:
    ...
    olhosDetectados = classificadorOlhos.detectMultiScale(regiaoCinzaOlho, scaleFactor=1.1, minNeighbors = 8) #E em seguida, utilizamos o classificador para detectar os olhos.
